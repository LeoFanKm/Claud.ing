...
export type RepoWithTargetBranch = {
  target_branch: string;
  id: string;
  path: string;
  name: string;
...
export type ListMembersResponse = {
  members: Array<OrganizationMemberWithProfile>;
};
...
export type RemoteProjectMembersResponse = {
  organization_id: string;
  members: Array<OrganizationMemberWithProfile>;
};
...
export type CreateGitHubPrRequest = {
  title: string;
  body: string | null;
...
export type McpConfig = {
  servers: { [key in string]?: JsonValue };
  servers_path: Array<string>;
  template: JsonValue;
...
export type ActionType =
  ...
  | { action: "file_edit"; path: string; changes: Array<FileChange> }
  ...
  | { action: "todo_management"; todos: Array<TodoItem>; operation: string }
