---
title: "Install & Run Kanban by Clauding"
description: "Complete installation guide for Kanban by Clauding on macOS, Linux, and Windows"
sidebarTitle: "Installation"
---

## Supported Systems

We build and test Kanban by Clauding on the following systems:
...
<Warning>
Kanban by Clauding runs AI agents with --dangerously-skip-permissions/--yolo flags by default so they can work autonomously without constant approval prompts. Each task runs in an isolated git worktree, preventing agents from interfering with each other.
